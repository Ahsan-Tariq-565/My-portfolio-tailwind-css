    ...
    <div className="w-full flex items-center py-4 px-6 bg-slate-950 justify-between fixed top-0 left-0 z-50">
      ...
      <Link href="/">
        <div>
          ...
          <p className="text-xs italic lg:text-sm text-gray-400">MUHAMMAD AHSAN</p>
        </div>
      </Link>
      ...
      <div className="hidden lg:flex gap-8 font-light text-lg text-white">
        ...
        <Link href="/#projects" className="hover:bg-slate-100/50 hover:rounded-lg px-4 py-2">
          PROJECT
        </Link>
        <Link href="/#skills" className="hover:bg-slate-100/50 hover:rounded-lg px-4 py-2">
          SKILLS
        </Link>
